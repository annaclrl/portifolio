...
export const experiences: Experiencia[] = [
    { data: "Abril de 2025 — Agosto de 2025", titulo: "Jovem Aprendiz", descricao: "Porto · Atendimento ao cliente - Cartão de crédito N1." },
    { data: "Janeiro de 2025 — Dezembro de 2026", titulo: "Formação acadêmica", descricao: "FIAP · Análise e Desenvolvimento de Sistemas." },
];